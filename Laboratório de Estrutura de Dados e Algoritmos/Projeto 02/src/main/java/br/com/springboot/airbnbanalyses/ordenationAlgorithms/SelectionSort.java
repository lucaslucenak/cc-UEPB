...
public class SelectionSort {
    ...
    public static void selectionSortDecrescent_List(List<AirBnbListings> listings_review_date) {
    ...
    public static void selectionSortDecrescent_arrays(Integer[] arrayPrice, Integer[] arrayId, Integer[] arrayHostId, Integer[] arrayMinimumNights, Integer[] arrayNumberOfReviews, Integer[] arrayCalculatedHostListingsCount, Integer[] arrayAvailability365, String[] arrayName,
