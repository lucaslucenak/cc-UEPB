...
class Paragraphs extends React.Component {
    render() {
        return (
            ...
            <p className="paragraph"><mark>Lorem Ipsum</mark> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                been
            ...
            <p className="paragraph">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece
                of classical Latin
